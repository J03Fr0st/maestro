# Refactoring Patterns & Code Smell Catalog

Reference catalog of common code smells with before/after examples. Use these patterns when identifying and fixing structural issues in code.
...
Use when: conditional logic selects between different algorithms or behaviors.
...
Use when: validation or processing involves a sequence of independent checks.
