...
await new Promise(r => setTimeout(r, 200));   // 200ms = 2 ticks - documented
```

Requirements: First wait for triggering condition, based on known timing, comment explaining WHY.
