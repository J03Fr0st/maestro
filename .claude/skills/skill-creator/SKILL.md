...
Skills use a three-level loading system to manage context efficiently (per [spec](https://agentskills.io/specification)):
...
**Important guidelines (per [spec](https://agentskills.io/specification)):**

- **Use relative paths** - Reference files using relative paths from the skill root (e.g., `references/REFERENCE.md`, `scripts/extract.py`)
...
Write the YAML frontmatter following the [Agent Skills Specification](https://agentskills.io/specification):
...
- `description`: Primary triggering mechanism - helps the agent understand when to use the skill
  - Max 1024 characters
...
- `license`: License name or reference to a bundled license file (e.g., `Apache-2.0` or `LICENSE.txt has complete terms`)
- `compatibility`: Environment requirements - max 500 characters (e.g., `Requires git, docker, jq, and access to the internet`)
...
Validation ensures skills conform to the [Agent Skills Specification](https://agentskills.io/specification). You can also use the official [skills-ref](https://github.com/agentskills/agentskills/tree/main/skills-ref) reference library:
...
1. **Validate** the skill automatically, checking:
   ...
   - Skill naming conventions (lowercase, hyphens, max 64 chars, matches directory)
   - Description completeness and quality (max 1024 chars)
